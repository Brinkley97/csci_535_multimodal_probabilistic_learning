...
# https://github.com/danijel3/PyHTK/blob/master/python/HTKFeat.py
...
class MFCC_HTK:
    ...
    def load_filter(self, filename):
        ...
        self.filter_num = np.max(data[:, 1]).astype('int')
    ...
    def __init__(self,
        ...
        self.fft_len = 2 ** int((np.floor(np.log2(self.win_len)) + 1))
